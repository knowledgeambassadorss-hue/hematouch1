        ...
        <div className="max-w-6xl mx-auto">
          ...
          <Card className="bg-card/90 backdrop-blur-2xl border-2 border-border/50 shadow-[var(--shadow-premium)] overflow-hidden animate-scale-in">
            <CardContent className="p-8 md:p-12 lg:p-20 text-center">
              ...
              {/* English Translation */}
              <p className="text-lg md:text-xl lg:text-2xl text-muted-foreground mb-10 md:mb-14 max-w-4xl mx-auto leading-relaxed text-center animate-fade-up" style={{ animationDelay: '0.6s' }}>
