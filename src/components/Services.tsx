...
const Services = () => {
  const services = [
    ...
    },
    {
      ...
      description: "استراتيجيات إعلانية تضع علامتك في قلب السوق، وتجذب لك العملاء الأكثر استعدادًا للشراء.",
    ...
    },
    {
      ...
      description: "نترجم أفكارك المعقدة إلى فيديوهات آسرة تبسط رسالتك، وتترك انطباعًا لا يُمحى.",
      link: "/services/motion-graphics"
    },
    {
      icon: influencerIcon,
      title: "حملات التسويق عبر المؤثرين",
      description: "نصل بعلامتك التجارية إلى جمهور أوسع وأكثر تفاعلًا من خلال حملات مدروسة مع المؤثرين.",
