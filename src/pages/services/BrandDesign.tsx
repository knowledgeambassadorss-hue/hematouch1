          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="bg-card/50 backdrop-blur-xl rounded-3xl p-8 md:p-12 mb-12 border-2 border-primary/10 shadow-lg">
              <p className="text-xl md:text-2xl text-foreground leading-relaxed text-justify">
                هل تبحث عن هوية بصرية احترافية قوية تعكس قيم وشخصية علامتك التجارية بدقة واحترافية عالية؟ في هيما تاتش، نقدم لك باقة شاملة متكاملة من الحلول الإبداعية المتخصصة لتصميم هوية بصرية مميزة فريدة تعزز بقوة حضورك ومكانتك في السوق التنافسي وتترك انطباعاً قوياً ودائماً لا يُنسى لدى جمهورك المستهدف وعملائك المحتملين، نعتمد بشكل كامل على استراتيجيات تصميم إبداعية مدروسة بعناية لكل نشاط تجاري على حدة، مع إنشاء شعار احترافي مميز، اختيار دقيق للألوان والخطوط المناسبة المتناسقة، وتطوير دليل هوية بصرية شامل متكامل لضمان الاتساق والتناسق التام لعلامتك التجارية عبر جميع المنصات والقنوات.
              </p>
            </div>
