        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-8">
            ...
            <div className="inline-flex items-center justify-center w-32 h-32 rounded-2xl bg-white shadow-lg mb-8">
              <img src={ecommerceIcon} alt="بناء وإدارة المتاجر الإلكترونية" className="w-20 h-20 object-contain" />
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="text-muted-foreground mb-8 leading-relaxed text-justify">
                في هيما تاتش، نقدم لك باقة حلول تقنية متكاملة شاملة لإنشاء وتطوير متجرك الإلكتروني الاحترافي المتطور، مما يساعدك بفعالية كبيرة على تحقيق معدلات مبيعات أكبر بكثير، وصول أوسع وأشمل لجمهورك المستهدف، ونمو تجاري مستدام طويل الأمد وقوي، نقوم بإنشاء وتصميم متجر إلكتروني احترافي متميز يعكس بدقة هوية علامتك التجارية الفريدة ويوفر تجربة مستخدم سلسة مريحة وممتعة لجميع عملائك الحاليين والمحتملين.
              </p>
