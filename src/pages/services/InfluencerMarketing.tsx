          ...
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="text-muted-foreground mb-8 leading-relaxed text-justify">
                في هيما تاتش، نقدم لك خدمات متخصصة احترافية في التسويق عبر المؤثرين لمساعدتك بفعالية كبيرة على الوصول إلى جمهور أوسع بكثير وأكثر تنوعاً وبناء ثقة قوية راسخة مع عملائك المحتملين والحاليين بطرق مؤثرة، نعمل بشكل وثيق مع مجموعة واسعة متنوعة من المؤثرين الموثوقين في مختلف المجالات والتخصصات المتعددة لضمان تحقيق جميع أهدافك التسويقية والتجارية المرجوة بأعلى كفاءة ممكنة.
              </p>
