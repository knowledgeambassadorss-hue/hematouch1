          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="bg-card border border-border rounded-2xl p-8 md:p-12 mb-8 shadow-lg">
              <p className="text-xl md:text-2xl text-foreground leading-relaxed text-justify">
                هل تبحث عن فيديو موشن جرافيك احترافي إبداعي يعزز بقوة مكانة علامتك التجارية ويوصل رسالتك بوضوح تام؟ في هيما تاتش، نقدم لك باقة حلول إبداعية متكاملة مبتكرة لإنتاج فيديوهات موشن جرافيك عالية الجودة تجذب الانتباه بقوة، توضح أفكارك ورسائلك بطريقة مبسطة وجذابة، وتساعد بفعالية كبيرة في إيصال رسالتك التسويقية بطريقة مؤثرة لا تُنسى، نعتمد بشكل كامل على تطبيق استراتيجيات بصرية إبداعية مخصصة بعناية فائقة، مع تصاميم احترافية متقنة عالية الجودة، سيناريوهات إبداعية مبتكرة مدروسة بعناية، ورسوم متحركة جذابة مميزة تأسر القلوب.
              </p>
            </div>
