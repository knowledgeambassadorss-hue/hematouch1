          ...
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="text-muted-foreground mb-8 leading-relaxed text-justify">
                في هيما تاتش، نقدم لك خدمات متخصصة احترافية في تحسين محركات البحث لمساعدتك على الظهور بقوة في النتائج الأولى المتقدمة على محرك البحث جوجل وجذب أعداد أكبر بكثير من العملاء المحتملين المهتمين بمنتجاتك أو خدماتك بشكل طبيعي عضوي ومستدام طويل الأمد، نعتمد بشكل كامل على تطبيق أفضل الممارسات العالمية المجربة والأدوات التقنية المتقدمة الاحترافية لضمان تحسين شامل لموقعك الإلكتروني وزيادة كبيرة ملحوظة في معدلات ظهوره في نتائج البحث الأولى.
              </p>
