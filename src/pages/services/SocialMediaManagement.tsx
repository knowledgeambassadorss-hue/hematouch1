          ...
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="text-muted-foreground mb-8 leading-relaxed text-justify">
                في هيما تاتش، نقدم لك خدمات متكاملة شاملة لإدارة جميع حسابات التواصل الاجتماعي الخاصة بك بشكل احترافي متميز، مما يساعدك على بناء حضور رقمي قوي ومؤثر، زيادة معدلات التفاعل الإيجابي مع جمهورك المستهدف بفعالية، وتحقيق جميع أهدافك التسويقية والتجارية المرجوة بكفاءة عالية، نعمل باستمرار على إنشاء وإنتاج محتوى إبداعي جذاب ومميز، التفاعل المستمر والاحترافي مع المتابعين والعملاء، وتحليل دقيق شامل للأداء والنتائج لضمان تحقيق أفضل وأقوى النتائج الممكنة التي تتجاوز توقعاتك.
              </p>
