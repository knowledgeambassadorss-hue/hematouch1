          ...
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="text-muted-foreground mb-8 leading-relaxed">
                في هيما تاتش، نقدم خدمات التعليق الصوتي الاحترافي بأصوات متنوعة تناسب جميع أنواع المحتوى. سواء كنت بحاجة إلى تعليق صوتي لفيديو تسويقي، إعلان، أو محتوى تعليمي، نوفر لك أفضل الأصوات بجودة عالية.
              </p>
